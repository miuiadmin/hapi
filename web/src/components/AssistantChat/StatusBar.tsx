...
export function StatusBar(props: {
    ...
    const codexReasoningLabel = shouldShowCodexReasoningLabel(props.agentFlavor)
        ...
        : null
    // Fast mode is only active when the session's explicit service tier says so;
    // no effort/model-name heuristic — a low effort or mini model is not Fast.
    const codexFastMode = props.agentFlavor === 'codex' && isFastServiceTier(props.serviceTier)
